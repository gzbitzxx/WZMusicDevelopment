  ...
  <body>
    <div class="showbox" style="width: 80%;"">
        <form method="post" action="#">
            ...
            <div class="form-group">
                <label >作者</label>
                <input type="text" class="form-control userID" value="<%=user.getRealName() %>" readonly="readonly" >
                 <input type="hidden" class="form-control userID" value="<%=user.getId()%>" name="userID" >
            </div>
            <div class="form-group">
