...
<title>My JSP 'UpdatePageArticle.jsp' starting page</title>
...
<body>
    <div class="showbox" style="width: 80%;">
        <form method="post">
            ...
            <div class="form-group">
                <label >作者</label>
                <input type="hidden"  name="userID" value=<%=user.getId()%> class="update_userID" >
                <input type="text"   value=<%=user.getRealName()%> readonly="readonly">
            </div>
            <div class="form-group">
                <label >归属音乐</label>
                <br />
