	...
	<div class="love_song_body">
		<div id="title">
			...
			<div class="love_song_right">
				<div class="love_song_title">
					<span class="glyphicon glyphicon-time"></span>最近
				</div>
				<div style="float:left;">
					<img src="WZMusic/images/zxx.jpg" />
				</div>
				<div style="float:left; margin-top:20px;">
					<span>&nbsp;&nbsp;&nbsp;&nbsp;<span
						class="glyphicon glyphicon-headphones"></span><%=user.getAccoutNumber()%>
						&nbsp;&nbsp;&nbsp;
					</span> <small> 2017 年 02 月 20 日 </small>
				</div>
				<div style="clear:both;"></div>
				<div style="margin-top:20px;">
					<button type="button" class="btn btn-info">
						<span class="glyphicon glyphicon-play-circle" title="播放"></span>播放
					</button>

					<button type="button" class="btn btn-info">
						<span class="fui-folder" title="收藏"></span>收藏
					</button>

					<button type="button" class="btn btn-info">
						<span class="glyphicon glyphicon-share-alt" title="分享"></span>分享
					</button>

					<button type="button" class="btn btn-info">
						<span class="glyphicon glyphicon-download" title="下载"></span>下载
					</button>

					<button type="button" class="btn btn-info">
						<span class="fui-bubble" title="评论"></span>评论
					</button>
				</div>
			</div>
			...
			<div class="wz_index_head_one">
				<a href="#" class="wz_index_head_one_title">歌曲列表</a><small>&nbsp;&nbsp;<samp><%=music.size()%></samp>首歌
				</small><span class="wz_left"><a href="#">播放：<samp
							style="color:#F00;">0</samp>次
				</a></span>
			</div>
			...
			<div style="margin-top:10px; width:95%; margin: 0 auto 0;">
				<table class="table table-hover">
					...
					<tbody>
						...
						%>
						<tr>
							<td style="width:8%;"><%=number%> <span
								class="glyphicon glyphicon-play-circle" title="播放"></span></td>
			...
			<div style=" width:100%; margin:0 auto 0;">
				<ul class="pagination" style="width:100%;">
					...
					<li class="next"><a href="#fakelink" class="fui-arrow-right"></a>
					</li>
				</ul>
			</div>
			<!-- /pagination -->
